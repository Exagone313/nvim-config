...
* [ide.lua](./lua/config/ide.lua): IDE mode, togglable from the menu
* [terminal.lua](./lua/config/terminal.lua): terminal popup, opened from the menu
...
* [Noice](https://github.com/folke/noice.nvim) ([fork](https://github.com/Exagone313/noice.nvim)): enter commands and searches from a pop-up in the middle of the editor, show messages in pop-ups
